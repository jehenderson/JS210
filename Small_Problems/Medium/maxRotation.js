...
// 321759. Keep the first three digits fixed in place and rotate again to
// get 321597. Finally, keep the first four digits fixed in place and rotate
// the final two digits to get 321579. The resulting number is called the maximum
...
function maxRotation(num) {
  numRotations = String(num).length;
  let output = num;
  for (var i = 0; i < numRotations; i++) {
    output = rotateRightmostDigits(output, numRotations - i);
  }
